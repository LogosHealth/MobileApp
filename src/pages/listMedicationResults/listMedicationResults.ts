...
@Component({
  ...
  templateUrl: 'listMedicationResults.html'
})
export class ListMedicationResults {
  list2: TreatmentResults = new TreatmentResults();
  feed: FeedModel = new FeedModel();
  formName: string = "listMedicationResults";
  loading: any;
  resultData: any;
  userTimezone: any;
  loadFromId: any;
  ...
  loadData() {
    ...
    restURL="https://ap6oiuyew6.execute-api.us-east-1.amazonaws.com/dev/TreatmentResultByMed";
